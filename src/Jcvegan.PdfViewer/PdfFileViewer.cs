  ...
  public class PdfFileViewer : Control {
    public static readonly DependencyProperty FileSourceProperty =
        DependencyProperty.Register(
            "FileSource", typeof(string), typeof(PdfFileViewer),
            new FrameworkPropertyMetadata(
                null, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault,
                OnFileSourceChanged));

    private static void
    OnFileSourceChanged(DependencyObject d,
    ...
    static PdfFileViewer() {
      DefaultStyleKeyProperty.OverrideMetadata(
          typeof(PdfFileViewer),
          new FrameworkPropertyMetadata(typeof(PdfFileViewer)));
    }
